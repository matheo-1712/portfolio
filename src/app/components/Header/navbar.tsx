  ...
  return (
    <nav className="pointer-events-auto bg-white/70 dark:bg-black/70 backdrop-blur-2xl border border-white/20 dark:border-white/10 shadow-2xl shadow-black/10 dark:shadow-black/40 rounded-full px-2 py-2 flex items-center gap-1 transition-all duration-300 hover:scale-[1.02] hover:bg-white/80 dark:hover:bg-black/80 ring-1 ring-black/5 dark:ring-white/10">
      ...
      <Link
        ...
        title="Mon GitHub"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="text-gray-700 dark:text-gray-300 group-hover:text-black dark:group-hover:text-white transition-colors">
      ...
      <Link
        ...
        title="Mon CV"
      >
        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-gray-700 dark:text-gray-300 group-hover:text-black dark:group-hover:text-white transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
