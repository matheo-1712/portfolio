...
export default function Projet_OtterlyApi() {
        ...
        <div className="items-center justify-center">
            ...
            <div id="content" className="mt-12">
                ...
                <div id="Fonctionnalités">
                    ...
                    <div id="text" className="my-6">
                        <p>Voici les principales fonctionnalités de OtterlyAPI :</p>
                        <br />
                ...
                <div id="Test">
                    ...
                    <div id="text" className="my-6">
                       <p>Cette API étant encore en cours de développement, les tests ne sont pas encore disponibles.</p>
                    </div>
